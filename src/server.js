...
// トップページのヒーロー画像。キャッチコピーは画像に焼き込まれているため、
// 文字を重ねずに画像をそのまま全幅で表示する。
// /admin/images から同じファイル名でアップロードすれば差し替えられる。
const HOME_HERO_IMAGE = '/uploads/images/home-hero.jpg.jpg';
const HOME_HERO_IMAGE_WIDTH = 1536;
const HOME_HERO_IMAGE_HEIGHT = 1024;
const HOME_HERO_ALT =
  '自然の命式でみる四柱推命 ― 自分の性質と流れを理解し、よりよい選択と行動につなげるための知恵をお届けします。';

function renderHomeHeroSection() {
  return `
    <section class="home-hero">
      <h1 class="visually-hidden">自然の命式でみる四柱推命</h1>
      <img
