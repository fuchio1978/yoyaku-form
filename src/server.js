    ...
    <script>
      (function() {
        ...
        function mapToText(map) {
          ...
          var lines = dates.map(function(date) {
            var slotsMap = map[date] || {};
            var slots = Object.keys(slotsMap)
              .filter(function(s) { return slotsMap[s]; })
              .sort();
        ...
        function buildCalendar(container, state, onDateClick) {
          ...
          function updateCalendar() {
            // Clamp month/year within [today, today+1month]
          ...
          function renderTimes() {
            ...
            HOURS.forEach(function(h) {
              ...
              cb.addEventListener('change', function() {
                ...
                personState.map[personState.selectedDate][label] = cb.checked;
        ...
        function createPersonUI(container, state, personLabel) {
        ...
        createPersonUI(tContainer, tetsuyaState, 'てつ先生');
        createPersonUI(cContainer, chigusaState, 'ちぐさ');
